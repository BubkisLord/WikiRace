      ...
      <div className="flex flex-1 items-center justify-center">
        {!isHosting ? (
          ...
          <div className="bg-gray-700 shadow-lg rounded-lg p-8 w-full max-w-md">
            ...
            {loadingStartGame && randomTip && <p className="text-gray-100 text-center mt-4" style={{marginBottom: "0px"}}>Tip: {randomTip}</p>}
            {error && <p className="text-red-500 text-center mt-4" style={{marginBottom: "0px"}}>{error}</p>}
          </div>
        )}
      </div>
      <style>
