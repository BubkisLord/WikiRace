...
import { getGameStateByJoinCode, getStartAndEndPagesByJoinCode, getVisitedLinksByJoinCode, getWinnerByJoinCode } from '../database';
    ...
    const renderContent = () => {
                ...
                <div className="flex flex-col items-center justify-center min-h-screen bg-gray-700 text-gray-100">
                    ...
                    <div className="w-full max-w-4xl bg-gray-800 p-4 rounded-lg shadow-md">
                        ...
                        <ul className="space-y-4">
                            {playerPaths && Object.entries(playerPaths).map(([player, path], index) => (
        ...
        return (
            ...
            <header className="w-full bg-blue-600 text-gray-100 py-4 shadow-md">
                <h1 className="text-center text-2xl font-bold">TARGET: {pages["endPage"]}</h1>
            </header>
            <main className="flex-grow w-full p-4">
                <WikipediaNavigator playerName={localStorage.getItem('playerName')} joinCode={joinCode} startPage={pages["startPage"]} endPage={pages["endPage"]} />
            </main>
